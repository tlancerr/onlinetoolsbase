...
export async function POST(req: Request) {
  try {
    ...
    const user = `
Create 10 Twitter/X bio variations for this niche keyword: "${keyword}"
...
- No hashtags spam
- Make them clean, modern, and human
- Mix styles: professional, witty, minimal, creator, builder, educator
- Avoid emojis overload (0-2 emojis max per bio)
`;
