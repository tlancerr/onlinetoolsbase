...
export async function POST(req: Request) {
  try {
    ...
    const system =
      "You are a YouTube SEO expert. Return ONLY valid JSON. No markdown. No extra text.";

    const user = `
Generate 20 optimized YouTube tags for this keyword: "${keyword}"
...
Rules:
- Exactly 20 tags
- Include # sign in every tag
- Mix short, medium and long-tail tags
- Avoid spam
- Avoid repeating identical tags
