...
export default function SiteHeader() {
  ...
  <div className="absolute right-0 top-full z-50 mt-2">
    <div className="min-w-[220px] rounded-xl border border-slate-800 bg-slate-950 shadow-2xl overflow-hidden">
      <div className="py-2">
        <Link
          href="/blog"
          className="block px-4 py-3 text-left text-sm text-slate-200 hover:bg-slate-900 whitespace-nowrap"
